...
export async function POST(req: Request) {
  ...
  console.log("Latest message:", latestMessage); // Debug log
    ...
    const response = await ai.models.generateContent({
        ...
        config: {
            systemInstruction: "You are a college counselor. Return ONLY a JSON array of course IDs, nothing else.",
    ...
    try {
        ...
        const aiResponse = { role: "assistant", content: JSON.stringify(parsedResponse) };
